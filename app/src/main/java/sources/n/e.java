...
public final class e extends InputConnectionWrapper {
    ...
    public final boolean performPrivateCommand(java.lang.String r12, android.os.Bundle r13) {
        ...
        L_0x0067:
            ...
            A.j r10 = new A.j     // Catch:{ all -> 0x0031 }
            r10.<init>(r6, r7, r8)     // Catch:{ all -> 0x0031 }
            boolean r2 = r0.a(r10, r9, r3)     // Catch:{ all -> 0x0031 }
        L_0x007a:
        ...
        L_0x0089:
            ...
            return r12
        */
        throw new UnsupportedOperationException("Method not decompiled: N.e.performPrivateCommand(java.lang.String, android.os.Bundle):boolean");
    }
}
