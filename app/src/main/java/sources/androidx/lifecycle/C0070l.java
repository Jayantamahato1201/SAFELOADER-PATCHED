...
public enum C0070l {
    ...
    public static final C0068j Companion = null;
    ...
    static {
        /*
            ...
            ON_ANY = r13
            r14 = 7
            androidx.lifecycle.l[] r14 = new androidx.lifecycle.C0070l[r14]
            r14[r6] = r7
            r14[r5] = r8
            r14[r4] = r9
            r14[r3] = r10
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.lifecycle.C0070l.<clinit>():void");
    }

    public final m a() {
        switch (C0069k.f1430a[ordinal()]) {
            case 1:
            case 2:
                return m.f1432h;
            case 3:
