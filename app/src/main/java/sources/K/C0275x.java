...
public class C0275x extends ImageButton {

    /* renamed from: a  reason: collision with root package name */
    public final C0258o f3592a;
    ...
    public C0275x(Context context, AttributeSet attributeSet, int i2) {
    ...
    public void setImageDrawable(Drawable drawable) {
        C0277y yVar = this.b;
        if (!(yVar == null || drawable == null || this.f3593c)) {
